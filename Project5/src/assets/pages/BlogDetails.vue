                    ...
                    <div class="details-block">
                        <section class="article_block">
                            <div class="heading-block">
                                ...
                                <p class="project-subtitle">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae
                                    ...
                                    injecthumour, or randomised words which don t look even slightly believable.Embarrassing
                        ...
                        <div>
                            ...
                            <div class="tags-block">
                                <button :key="button.id" v-for="(button) in allArticlesTags" @click="filterByTag(button)"
                                    class="tag-button">
                                    {{ button.title }}
                                </button>
                            </div>
