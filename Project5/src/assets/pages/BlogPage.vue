<template>
    <div>
        <HeaderBlock />
        <main>
            <TitleBlock :title="title" :subtitle="subtitle" :img="img" />
            ...
            <section class="blog center">
                <a class="article-heading" @click="$router.push({ path: '/BlogDetails' })">Articles & News</a>
                ...
                <div id="pages" class="pagination">
                    <router-link v-for="page in 3" :to="`/BlogPage/${page}`" :key="page" class="container">
                        <a href="#" class="pagination__pages">
